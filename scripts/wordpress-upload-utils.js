...
function buildScopedStyleBlock() {
  return [
    ...
    '.related-buying-guide { margin: 1.4rem 0 1.8rem; padding: 1.15rem 1.25rem; border-radius: 18px; border: 1px solid #d8c5ad; background: linear-gradient(180deg, #fff8ed 0%, #f7ecdc 100%); box-shadow: 0 10px 26px rgba(44, 36, 23, 0.06); }',
    '.related-buying-guide h3 { margin: 0 0 0.45rem; }',
    '.related-buying-guide p { margin: 0 0 0.85rem; }',
    '.related-buying-guide a { display: inline-flex; align-items: center; justify-content: center; min-height: 42px; padding: 0.55rem 1rem; border-radius: 999px; background: #2d5b43; color: #fff; text-decoration: none; font-weight: 700; }',
