...
function buildScopedStyleBlock() {
  return [
    ...
    '.hdl-toc { margin: 2rem auto; padding: 1.25rem 1.5rem; max-width: 720px; border: 1px solid #e4d8ca; border-radius: 16px; background: #fbf7f2; }',
    '.hdl-toc h2 { margin: 0 0 0.85rem; text-align: center; font-weight: 700; color: #111; }',
    '.hdl-toc ul { margin: 0; padding: 0; list-style: none; text-align: center; }',
    '.hdl-toc li + li { margin-top: 0.55rem; }',
    '.hdl-toc a { color: #111; text-decoration: none; border-bottom: 1px solid rgba(17, 17, 17, 0.18); }',
    '.hdl-toc a:hover, .hdl-toc a:focus { border-bottom-color: rgba(17, 17, 17, 0.48); }',
    '.hdl-jump-links { margin: 1.1rem auto 2rem; max-width: 820px; display: flex; flex-wrap: wrap; justify-content: center; gap: 0.7rem; }',
    '.hdl-jump-links a { display: inline-flex; align-items: center; justify-content: center; padding: 0.65rem 1rem; border-radius: 999px; border: 1px solid #e1d1be; background: #fffaf3; color: #2d261d; text-decoration: none; font-weight: 600; box-shadow: 0 8px 22px rgba(44, 36, 23, 0.05); }',
    ...
    '@media (max-width: 720px) { .hdl-article-content { max-width: 100%; } .hdl-quick-answer p strong { min-width: 0; display: block; margin-bottom: 0.25rem; } .hdl-product-review-card { padding: 1.1rem 1rem; } .hdl-jump-links { justify-content: stretch; } .hdl-jump-links a { width: 100%; } }',
    '</style>',
  ].join('\n');
}
